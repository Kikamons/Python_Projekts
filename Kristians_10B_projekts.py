...
def print_pauze(teksts, laiks):
    ...
    time.sleep(laiks)
print_pauze("Ir sācies vasaras brīvlaiks!", 2)
print_pauze("Tu ar saviem diviem draugiem, Tomasu un Elizabeti, esat izdomājuši apmeklēt spocīgu māju.", 4)
#\n funkcija pārvieto nākošo teksta daļu jaunā rindā.
print_pauze("Vai vēlies iet iekšā viens pats, ar draugiem vai iet mājās?\n", 3)
while True:
    sakums = input("Izvēles opcijas: Viens, Kopā vai Iet mājās.\n> ")
    if sakums.lower().strip() == "viens":
        ...
        while True:
            viens1 = input("Izvēles opcijas: Virtuve vai Dzīvojamā istaba.\n> ")
            if viens1.lower().strip() == "virtuve":
                ...
                while True:
                    viens2 = input("Izvēles opcijas: Cīnīties vai Skriet prom.\n> ")
                    if viens2.lower().strip() == "cīnīties":
                        print_pauze("Tu mēģināji būt drosmīgs un cīnīties!", 2)
                        ...
                        print_pauze("Tu aizmuki no Monas Lizas izskrienot ārā no mājas!", 2)
                ...
                while True:
                    ...
                    if viens3.lower().strip() == "istaba":
                        ...
                        print_pauze("Tu izdomāji darīt gudro izvēli un gāji prom.", 3)
        ...
        while True:
            kopa1 = input("Izvēles opcijas: Virtuve vai Dzīvojamā istaba.\n> ")
            if kopa1.lower().strip() == "virtuve":
                ...
                while True:
                    kopa2 = input("Izvēles opcijas: Cīnīties vai Skriet prom.\n> ")
                    if kopa2.lower().strip() == "cīnīties":
                        print_pauze("Kamēr tu ar Elizabeti novērsi Monas Lizas uzmanību.", 2)
                ...
                print_pauze("Jūs iegājāt dzīvojamajā istabā...", 2)
                ...
                while True:
                    kopa3 = input("Izvēles opcijas: Tomas vai Elizabete.\n> ")
                    if kopa3.lower().strip() == "tomas":
                        print_pauze("Tu izvēlējies klausīt Tomasu.", 2)
                        ...
                        print_pauze("Tu izvēlējies klausīt Elizabeti.", 2)
        ...
        print_pauze("Jūs izdomājāt iet mājās.", 1)
